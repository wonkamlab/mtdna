...
#export HP_RDIR=/vast/awonkam1/resources/hg38/refgenome/
...
if [[ "${ref}" == "mm39" ]]; then
  ...
  export HP_RMT=chrM
  export HP_RNUMT="chr1:564464-570304 chr13:110076472-110076727 chr17:22020534-22020965"
  export HP_RURL=http://hgdownload.cse.ucsc.edu/goldenpath/hg19/bigZips/hg19.fa.gz
elif [[ "${ref}" == "hg18" ]]; then
  #hg18
  export HP_RNAME=hg18
  export HP_RMT=chrM
  export HP_RNUMT="chr1:554327-560167 chr13:108874473-108874728 chr17:21944661-21945092"
  export HP_RURL=http://hgdownload.cse.ucsc.edu/goldenpath/hg18/bigZips/hg18.fa.gz
elif [[ "${ref}" == "chm13" ]]; then
  #CHM13
...
elif [[ "${ref}" == "chm13v2" ]]; then
  #CHM13.v2; to compute NUMT regions
  export HP_RNAME=chm13
  export HP_RMT=chrM
  export HP_RNUMT="chr5:81136887-81137073 chr11:10594619-10594811 chr13:12167063-12168420 chr17:23209322-23209958"
  export HP_RURL=https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/011/914/755/GCF_009914755.1_T2T-CHM13v2.0/GCF_009914755.1_T2T-CHM13v2.0_genomic.fna.gz
else
  #hs38DH(default)
  #export HP_RNAME=hg38
  export HP_RNAME=hs38DH
  export HP_RMT=chrM
  export HP_RNUMT="chr1:629084-634672 chr17:22521208-22521639"                                             # 150bp reads chr2:32916199-32916630
  #export HP_RNUMT="chr1:629084-634924 chr13:109424125-109424380 chr17:22521208-22521639"   
  ...
  #export HP_RURL=file:///vast/awonkam1/resources/hg38/refgenome/hg38.fa
fi
...
export HP_BOPT=""                # BWA options
export HP_FOPT="-q 15 -e 0"      # FASTP options: Ex: " -q 20 -e 30 "; -q: min base quality; -e: avg quality thold
export HP_DOPT=""                # samblaster options
if [ ! -z $HP_PAIRED ] && [ $HP_PAIRED -ne "0" ] ; then
  HP_BOPT="-p"
  HP_FOPT="$HP_FOPT --interleaved_in"
  HP_DOPT="--removeDups"
fi
...
export HP_P=${threads}				       		            # number of processors
export HP_MM=${memory}                                                   # maximum memory
...
export HP_ADIR=${bamdir} # bams or crams input file directory
export HP_ODIR=${outdir}        # pipeline output dir
